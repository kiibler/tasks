...
const Header = () => {
    ...
    return (
        <header className="flex min-h-28 border-b-2 border-gray-300 bg-gray-100">
            <div className="flex min-w-40 items-center justify-center border-r-2 border-gray-300 lg:min-w-60">
                <LuListTodo size={60} />
            </div>
